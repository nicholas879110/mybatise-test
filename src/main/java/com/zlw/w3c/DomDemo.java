...
public class DomDemo {
    ...
    public static void queryXml(){
        try{
            ...
            //把要解析的xml文档读入DOM解析器
            Document doc = dbBuilder.parse("D:\\project\\mybatise-test\\src\\main\\java\\com\\zlw\\w3c\\school.xml");
...
//            transformer.setOutputProperty(属性，属性值);//设置输出到文档时的格式，比如：换行等
            transformer.transform(new DOMSource(doc),new StreamResult("D:\\project\\mybatise-test\\src\\main\\java\\com\\zlw\\w3c\\insertSchool.xml"));
